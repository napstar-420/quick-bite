    ...
    <div className="max-w-md w-full mx-auto p-6">
      ...
      <div className="mb-8">
        ...
        <form className="space-y-4">
          <div className='w-full'>
            <label htmlFor="firstName" className="block text-sm text-gray-600 mb-1">Name</label>
            <Input id="firstName" defaultValue={user.name} className='w-full' />
          </div>

          <div>
            <label htmlFor="mobile" className="block text-sm text-gray-600 mb-1">Mobile number</label>
            <Input id="mobile" defaultValue={user.phone} />
          </div>

          <Button variant="outline" className="bg-gray-200 hover:bg-gray-300 text-gray-800">Save</Button>
        </form>
      </div>
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center justify-between py-3">
          <div className="flex items-center">
            <span className="font-medium text-blue-600 uppercase mr-2">Cash on delivery</span>
          </div>
          <div className="flex items-center">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <Card className="p-4 flex items-center justify-between">
            ...
            <Button variant="link" className="text-blue-500 p-0 h-auto">Connect</Button>
          </Card>
