...
const signinValidation = [
  ...
  body("password")
    ...
    .withMessage(`Password length should between ${config.PASS_MIN_LENGTH} and ${config.PASS_MAX_LENGTH}`)
...
const signupValidation = [
  body("name")
    ...
    .withMessage(`Name length should between ${config.NAME_MIN_LENGTH} and ${config.NAME_MAX_LENGTH}`),
  body("email")
    .trim()
    .escape()
    .notEmpty()
